...
<qgis version="3.14.15-Pi" styleCategories="AllStyleCategories" readOnly="0" simplifyMaxScale="1" simplifyDrawingTol="1" maxScale="0" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" minScale="100000000" labelsEnabled="0" simplifyLocal="1">
    ...
    <symbols>
      <symbol type="fill" name="0" alpha="1" force_rhr="0" clip_to_extent="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          ...
          <prop v="255,145,71,102" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="Pixel" k="offset_unit"/>
          <prop v="255,102,0,255" k="outline_color"/>
        ...
        <layer pass="0" enabled="1" class="LinePatternFill" locked="0">
          ...
          <symbol type="line" name="@0@1" alpha="1" force_rhr="0" clip_to_extent="1">
  ...
  <DiagramLayerSettings linePlacementFlags="18" showAll="1" dist="0" obstacle="0" priority="0" placement="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
